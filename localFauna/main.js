...
var $author$project$Pages$OrderTickets$FreeTicketsAvailableReceived = function (a) {
	return {$: 'FreeTicketsAvailableReceived', a: a};
};
var $author$project$Api$GetFreeTicketsAvailable$Response = function (amount) {
...
var $author$project$Api$GetFreeTicketsAvailable$decoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'amount',
	$elm$json$Json$Decode$int,
	$elm$json$Json$Decode$succeed($author$project$Api$GetFreeTicketsAvailable$Response));
...
var $author$project$Api$GetFreeTicketsAvailable$dispatch = F2(
	function (baseApiUrl, msg) {
		var request = $elm$http$Http$request(
			{
				body: $elm$http$Http$emptyBody,
				expect: A2($elm$http$Http$expectJson, msg, $author$project$Api$GetFreeTicketsAvailable$decoder),
				headers: _List_Nil,
				method: 'POST',
...
var $author$project$Pages$OrderTickets$init = function (shared) {
	return _Utils_Tuple2(
		...
		A2($author$project$Api$GetFreeTicketsAvailable$dispatch, shared.baseApiUrl, $author$project$Pages$OrderTickets$FreeTicketsAvailableReceived));
};
...
var $author$project$Routes$changeRouteTo = F2(
	function (route, model) {
		switch (route.$) {
			...
			case 'Payment':
				var _v2 = $author$project$Pages$Payment$init(model.shared);
				var page = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'PaymentSuccess':
				var _v3 = $author$project$Pages$PaymentSuccess$init(model.shared);
				var page = _v3.a;
				var cmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var info = route.a;
				var _v4 = A2($author$project$Pages$Tickets$init, model.shared, info);
				var page = _v4.a;
				var cmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Domain$Event$FreeWithCode = function (a) {
	return {$: 'FreeWithCode', a: a};
};
var $author$project$Domain$Event$Standard = function (a) {
	return {$: 'Standard', a: a};
};
var $author$project$Domain$Event$theEvent = {
	address: 'Baron\nMechelseweg 21\n2811 Hombeek',
	date: 'Maandag 7 Oktober 2024',
	id: $elm$core$Maybe$Nothing,
	name: 'Afterwork Horeca Mechelen',
	ticketTypes: _List_fromArray(
		[
			$author$project$Domain$Event$Standard(
			{description: 'Leden', id: 'LID', price: 40}),
			$author$project$Domain$Event$Standard(
			{description: 'Niet-Leden', id: 'N-LID', price: 60}),
			$author$project$Domain$Event$FreeWithCode(
			{code: 'MMOKT0724', description: 'Gratis', id: 'GR', maxNumberOfTicketsTotal: 50, maxNumberofTicketsPerOrder: 2})
		]),
	time: '18:30'
};
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							info.description + (' - ' + A2($myrho$elm_round$Round$round, 2, info.price)))
						]));
			} else {
				return $rtfeldman$elm_css$Html$Styled$text('');
			}
...
var $author$project$App$view = function (model) {
	var mainFont = function () {
		var fontSize = function () {
			...
			if (_v1.$ === 'Phone') {
				return $rtfeldman$elm_css$Css$px(28);
			} else {
